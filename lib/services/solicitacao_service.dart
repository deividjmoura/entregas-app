...
class SolicitacaoService {
  ...
  static Future<Map<String, int>> minhasMensagensNaoLidas(String nome) async {
    final response = await ApiClient.get(
      '/solicitacoes/minhas-mensagens-nao-lidas?nome=${Uri.encodeComponent(nome)}',
    );
  ...
  static Future<void> marcarMensagensLidas(String solicitacaoId, String nome) async {
    await ApiClient.post(
      '/solicitacoes/$solicitacaoId/mensagens/lida',
      body: {'nome': nome},
    );
  }
}
